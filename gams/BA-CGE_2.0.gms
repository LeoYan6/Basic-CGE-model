...
*The bank absorbs households savings & government net surplus, and forms investment.
...
*imports, composite goods) & two factor markets.
*----------------------------------------------------------------------------------------------------
...
Scalars
    esubt   elasticity of substitution between labor and capital    /0.5/
...
Equations
*Production module
    QL_eq(t)    Conditional demand function of labor
    QK_eq(t)    Conditional demand function of capital
...
PA_eq(t)$(ts(t)).. // market clearance -- PA
    0       =g= ((gamd(t)*PD(t)**(1+etrax) + game(t)*PE(t)**(1+etrax)) - PA(t)**(1+etrax))$(etrax ne inf)
