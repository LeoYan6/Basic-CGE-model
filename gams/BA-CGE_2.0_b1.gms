$title  Basic CGE Model 2.0_beta1
...
Scalars
    ...
    etrax   elasticity of transformation in export CET function     /1.0/
...
*Production module
    ...
    QAs_eq(t)   Zero-profit -- activity output supply
    PAT_eq(t)   Calculation of pre-tax price (production tax)
*Trade (export) module
    QDs_eq(t)   Conditional supply function of domestic goods
    QE_eq(t)    Conditional supply function of exported goods
    QAd_eq(t)   Zero-profit -- activity output demand
*Trade (import) module
    PMT_eq(t)   Calculation of pre-tax price (import tariff)
    QDd_eq(t)   Conditional demand function of domestic goods
...
QL_eq(t)$(ts(t)).. // intermediate calculation -- QL
    QL(t)   =e= laml(t)**(esubt-1) * alpl(t) * (PAT(t)/PL(t))**esubt * QAs(t);
QK_eq(t)$(ts(t)).. // intermediate calculation -- QK
    QK(t)   =e= lamk(t)**(esubt-1) * alpk(t) * (PAT(t)/PK(t))**esubt * QAs(t);
QAs_eq(t)$(ts(t)).. // zero-profit condition -- QAs
...
*Trade (export) module
QDs_eq(t)$(ts(t)).. // intermediate calculation -- QDs
    QDs(t)  =e= gamd(t) * (PD(t)/PA(t))**etrax * QAd(t);
QE_eq(t)$(ts(t)).. // intermediate calculation -- QE
    QE(t)   =e= game(t) * (PE(t)/PA(t))**etrax * QAd(t);
QAd_eq(t)$(ts(t)).. // zero-profit condition -- QAd
    0       =g= PA(t)**(1+etrax) - (gamd(t)*PD(t)**(1+etrax) + game(t)*PE(t)**(1+etrax));
*Trade (import) module
PMT_eq(t)$(ts(t)).. // intermediate calculation -- PMT
    PMT(t)  =e= PM(t)/(1+txm(t));
QDd_eq(t)$(ts(t)).. // intermediate calculation -- QDd
    QDd(t)  =e= alpd(t) * (PC(t)/PD(t))**esubm * QC(t);
...
YG_eq(t)$(ts(t)).. // intermediate calculation -- YG
    YG(t)   =e= QAs(t)*PAT(t)*txp(t) + QM(t)*PMT(t)*txm(t) + (PL(t)*QL(t)+PK(t)*QK(t))*txh(t);
*Investment module
...
Model   main_model  BA-CGE  /
    QL_eq.QL, QK_eq.QK, QAs_eq.QAs, PAT_eq.PAT,
    QDs_eq.QDs, QE_eq.QE, QAd_eq.QAd, PMT_eq.PMT, QDd_eq.QDd, QM_eq.QM, QC_eq.QC, YFS_eq.YFS,
...
QAs.l(t)    =   vScl*sam('tot','act')/PA.l(t);
QDs.l(t)    =   vScl*(sam('act','com')-sam('com','row'))/PD.l(t);
QE.l(t)     =   vScl*sam('com','row')/PE.l(t);
QAd.l(t)    =   vScl*sam('act','com')/PA.l(t);
QDd.l(t)    =   vScl*(sam('act','com')-sam('com','row'))/PD.l(t);
...
display PAT.l, PMT.l,
        QL.l, QK.l, QAs.l, QDs.l, QE.l, QAd.l, QDd.l, QM.l, QC.l, QP.l, QG.l, QI.l, 
        YFS.l, YPC.l, YPS.l, YP.l, YGC.l, YGS.l, YG.l, YI.l,
        txp.l, txm.l, betas.l, txh.l;

*--------2.Calibrate Model Parameters----------------------------------------------------------------
alpl(t)     =   (QL.l(t)/QAs.l(t)) * (PL.l(t)/PAT.l(t))**esubt;
alpk(t)     =   (QK.l(t)/QAs.l(t)) * (PK.l(t)/PAT.l(t))**esubt;
aa(t)       =   QAs.l(t)/(QL.l(t)**alpl(t) * QK.l(t)**alpk(t));
laml(t)     =   1;
lamk(t)     =   1;

gamd(t)     =   (QDs.l(t)/QAd.l(t)) * (PA.l(t)/PD.l(t))**etrax;
game(t)     =   (QE.l(t)/QAd.l(t)) * (PA.l(t)/PE.l(t))**etrax;
alpd(t)     =   (QDd.l(t)/QC.l(t)) * (PD.l(t)/PC.l(t))**esubm;
alpm(t)     =   (QM.l(t)/QC.l(t)) * (PM.l(t)/PC.l(t))**esubm;
am(t)       =   QC.l(t)/(QDd.l(t)**alpd(t) * QM.l(t)**alpm(t));
...
Parameters
    ...
    qasck   Check changes in QAs
    patck   Check changes in PAT
    qdsck   Check changes in QDs
    qeck    Check changes in QE
    qadck   Check changes in QAd
    pmtck   Check changes in PMT
    qddck   Check changes in QDd
...
;
display qlck, qkck, qasck,
        qdsck, qeck, qadck, qddck, qmck, qcck, yfsck, 
...
;
display QL.l, QK.l, QAs.l,
        QDs.l, QE.l, QAd.l, QDd.l, QM.l, QC.l, YFS.l,
